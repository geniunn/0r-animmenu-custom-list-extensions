...
1. Open the 0r-animmenu folder in your resources directory.

2. Navigate to the customs folder inside it.

3. Locate the existing 10 language files in this folder.

4. Extract the downloaded ZIP file.

5. Copy the 10 language files from the ZIP and paste them into the customs folder.

6. When prompted, confirm that you want to replace the existing files.

7. Go back to the main 0r-animmenu folder and open the stream folder.

8. Delete the existing stream folder inside 0r-animmenu.

9. Copy the stream folder from the downloaded ZIP file and paste it into the 0r-animmenu folder.

Make sure all files are fully replaced before restarting your server.

# Credits:

- [The Popcorn RP community](https://discord.gg/popcornroleplay)
- [Mathu_lmn](https://github.com/Mathu-lmn)
- [Manason](https://github.com/Manason)
- [CritteRo](https://github.com/alberttheprince/rpemotes-reborn/blob/master/CritteRo)
- [ChristopherM](https://github.com/cm8263)
- [enzo2991](https://github.com/enzo2991)
- [DerDevHD](https://forum.cfx.re/t/fixed-remove-prop-after-scenario-animation/5002332/8)
- [iSentrie](https://forum.cfx.re/u/isentrie/)
- [Kibook](https://github.com/kibook)
- [AvaN0x](https://github.com/AvaN0x)
- [Mads](https://github.com/MadsLeander)
- [Tigerle](https://forum.cfx.re/u/tigerle_studios)
- [GeekGarage](https://github.com/geekgarage)
- [northsqrd](https://github.com/0sqrd)
- [Chico](https://forum.cfx.re/u/chico)
- [Scully](https://github.com/Scullyy/)
- Crusopaul and Eki
...
- [prue 颜](https://github.com/alberttheprince/rpemotes-reborn/blob/master/discord.gg/lunyxmods)
